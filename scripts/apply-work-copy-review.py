...
s=p.read_text()
replacements=[
("if(h) h.textContent='From conversation to completed action.';", "if(h) h.textContent='Voice requests connected to completed tasks.';"),
...
for old,new in replacements:
 ...
 s=s.replace(old,new)
p.write_text(s)
print('Updated the existing Our Work renderer; no new content layer or style changes.')
