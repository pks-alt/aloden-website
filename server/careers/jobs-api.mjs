...
export function renderBoardSnapshot(jobs,review=true){
  ...
  return `<!-- JOBS_SNAPSHOT_START --><div class="jobs-count"><span data-jobs-count role="status" aria-live="polite">${jobs.length} openings</span><span>Aloden careers</span></div><div class="jobs-list" data-jobs-list>${list}</div><script type="application/json" id="careers-initial-jobs">${JSON.stringify(review?{reviewOnly:true}:{reviewOnly:false,jobs}).replaceAll('<','\\u003c')}</script><!-- JOBS_SNAPSHOT_END -->`;
}
